...
namespace CleaningService
{
    public class Order : IComparable<Order>
    {
        ...
        public Order(DateTime orderDate, string fullNameClient, string phoneNumber,
            string address, double roomArea, List<CleaningService> services,
            Employee employee, string paymentStatus, string timeSlot)
        {
            OrderDate = orderDate;
        ...
        public double CalculatePrice()
        {
            ...
            switch (mainService)
            {
                ...
                case "Підтримувальне прибирання": total = 30 * RoomArea; break;
                case "Прибирання після ремонту": total = 100 * RoomArea; break;
                case "Прибирання будинку": total = 80 * RoomArea; break;
                case "Прибирання котеджу": total = 90 * RoomArea; break;
                case "Прибирання офісу": total = 50 * RoomArea; break;
                case "Прибирання ресторану": total = 70 * RoomArea; break;
                case "Прибирання магазинів": total = 55 * RoomArea; break;
                default: total = 40 * RoomArea; break;
            }
